...
//         axios.get("http://localhost:5000/api/org/info", { headers }),
//         axios.get("http://localhost:5000/api/posts", { headers }),
//         axios.get("http://localhost:5000/api/posts/sentiment-distribution", {
//           headers,
//         }),
//       ]);
...
//         <StatCard icon={<FileText className="text-blue-400" />} title="Total Feedback" value={totalPosts} color="text-blue-300" />
//         <StatCard icon={<Users className="text-green-400" />} title="Total Users" value={totalUsers} color="text-green-300" />
//         <StatCard icon={<Settings className="text-purple-400" />} title="Join Code" value={orgInfo.joinCode || "N/A"} color="text-purple-300" />
//       </div>

//       {/* Sentiment Chart */}
//       <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-700 shadow-lg mb-10">
//         <div className="flex items-center gap-4 mb-4">
//           <PieIcon className="text-yellow-300" />
//           <h2 className="text-xl font-bold text-white">📊 Sentiment Breakdown</h2>
//         </div>
...
//           </ResponsiveContainer>
//         ) : (
//           <p className="text-gray-400">No sentiment data yet.</p>
//         )}
//       </div>

//       {/* Recent Feedback */}
//       <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-700 shadow-lg mb-10">
//         <h2 className="text-xl font-bold mb-4 text-white">🗣️ Recent Feedback</h2>
...
//         <h2 className="text-xl font-bold mb-4 text-white">🏢 Organization Details</h2>
//         <p><strong className="text-gray-400">Name:</strong> {orgInfo.orgName || "N/A"}</p>
//         <p><strong className="text-gray-400">Email:</strong> {orgInfo.email || "N/A"}</p>
//         <p><strong className="text-gray-400">Type:</strong> {orgInfo.type || "N/A"}</p>
//       </div>
//     </div>
//   );
// }
